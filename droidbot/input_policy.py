...
class InputPolicy(object):
    ...
    def start(self, input_manager, device):
        """
...
class MonkeyInputPolicy(InputPolicy):
    
    def __init__(self, device, app):
        super(MonkeyInputPolicy, self).__init__(device, app)
    ...
    def generate_event(self):
        ...
        event = None
        if event is None:
            event = self.generate_event_monkey()
        self.last_state = self.current_state
        self.last_event = event
        return event
    
    def generate_event_monkey(self):
        ...
        self.logger.info("selected a random event.")
        return input_event
